# build the lyric recognization task evlaution set
...
class Generator:
    ...
    def prepare_lyric_asr_task(self, task_prompt, this_reason_data, this_semantic_data):
    ...
    def generate_lyric_asr(
        ...
        tokens, tokens_mask = self.prepare_lyric_asr_task(task_prompt, reason_token, semantic_token)
...
if __name__ == '__main__':
    ...
    for key in semantic_dict.keys():
        ...
        text_content = generator.generate_lyric_asr(task_name=data_content['task'], task_prompt = tmp_task_prompt,
