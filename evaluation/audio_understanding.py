...
if __name__ == '__main__':
    ...
    for key in data_dict.keys():
        ...
        if d['task'] == 'audio_understanding':
            tmp_text = d['text_seq_answer']
            gt_text = generator._text_tokenizer.decode(tmp_text)
        elif d['task'] == 'audio_understanding_cot':
            tmp_text = d['text_seq_answer']
            gt_text = generator._text_tokenizer.decode(tmp_text)
            tmp_cot = d['text_seq_cot']
            gt_cot = generator._text_tokenizer.decode(tmp_cot)
        else:
            print('error task')
            assert 1==2
        ...
        # print('task_format ', task_format)
        # assert 1==2
        text_content = generator.generate_answer(task_name=d['task'], task_prompt = tmp_task_prompt,
