# build the audio caption task evlaution set
...
class Generator:
    ...
    def prepare_audio_caption_task(self, task_prompt, this_reason_data, this_semantic_data):
    ...
    def generate_audio_caption(
        ...
        tokens, tokens_mask = self.prepare_audio_caption_task(task_prompt, reason_token, semantic_token)
...
if __name__ == '__main__':
    ...
    for key in semantic_dict.keys():
        ...
        text_content = generator.generate_audio_caption(task_name=data_content['task'], task_prompt = tmp_task_prompt,
